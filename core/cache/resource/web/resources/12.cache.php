<?php  return array (
  ...
  array (
    ...
    'pagetitle' => '3-комнатные квартиры',
    'longtitle' => '3-комнатные квартиры',
    'description' => '',
    'alias' => '3-bedroom',
    'link_attributes' => '',
    'published' => 1,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'database-objects/3-bedroom.html',
    'uri_override' => 0,
...
<head>
    ...
    <title>3-комнатные квартиры - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="database-objects/3-bedroom.html" method="post">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==12` 
                &tvPrefix=``]]
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>3-комнатные квартиры - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
