<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1408426388,
    'editedby' => 1,
    'editedon' => 1410045433,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1408426380,
    'publishedby' => 1,
    ...
    array (
      0 => 'tv.Employers',
      1 => '[{"MIGX_id":"1","name":"Каменецкая Анна Константиновна","image":"files/images/empl/employer-1.png","exp":"Опыт работы риэлтором 3 года","desc":"<p>В агентстве недвижимости «XXI век» работаю со дня его открытия, 8 октября 2013 года.</p>\\n\\n<p class=\\"empl-indent\\">Если вам нужен действительно знающий риэлтор и эксперт с опытом работы в данной сфере и успешно разбирающийся во всех тонкостях сделок с недвижимостью, то вам ко мне!</p>\\n\\n<p class=\\"empl-indent\\">Я очень хорошо умею слушать и понимать своих клиентов. Умение вникнуть в проблему и найти решение, — секрет всех моих успехов в сфере недвижимости. Я внимательно изучаю вопрос и стараюсь разобраться в нём до мелочей. И только после этого предлагаю варианты решения.</p>\\n\\n<p class=\\"empl-indent\\">Моё кредо — делать своё дело так, чтобы оно никогда не расходилось со словом, а клиенты получали от работы со мной не только положительный результат, но и позитивные эмоции, то есть заряд бодрости и здоровья.</p>\\n\\n<p>&nbsp;</p>\\n\\n<p><b><em>«Помогу Вам найти квартиру Вашей Мечты!»</em></b></p>\\n\\n<p>Звоните в любое время: 8 (423) 290-06-30, 8 (902) 505-06-30</p>\\n"},{"MIGX_id":"2","name":"Бесхлебнова Екатерина Викторовна","image":"files/images/empl/employer-2.png","exp":"Опыт работы риэлтором 5 лет","desc":"<p>С 2009 года работаю на рынке недвижимости в г. Владивостоке. Начинала стажером, теперь руковожу замечательной группой профессионалов. Я горжусь тем, что наши клиенты нами довольны. Например, 70% обращений к нам происходят по рекомендациям тех клиентов, кто уже имел с нами дело.</p>\\n\\n<p class=\\"empl-indent\\">Считаю важными в работе риэлтора — профессионализм, честность и скорость! Вижу свою задачу в том, чтобы помочь человеку решить все вопросы так же успешно, как я решала бы их для себя. В этом мне помогают знания, полученные в результате дополнительного образования в области недвижимости, многочисленных тренингов, а также многолетний опыт работы, а главное — то, что я люблю свою работу и наш коллектив единомышленников!</p>\\n\\n<p>&nbsp;</p>\\n\\n<p><b><em>«Помогу Вам найти квартиру Вашей Мечты!»</em></b></p>\\n\\n<p>Звоните в любое время: 8 (423) 290-88-07; 8 (902) 505-88-07</p>"},{"MIGX_id":"3","name":"Тарабарова Раиса Сергеевна","image":"files/images/empl/employer-3.png","exp":"Опыт работы риэлтором 5 лет.<br>В агентстве недвижимости «XXI век» работает со дня открытия","desc":"<p>Аренда жилья — это серьёзный и иногда сложный процесс. Для его успешного завершения первым шагом, на мой взгляд, является правильный выбор риелтора — профессионала в своём деле.</p>\\n\\n<p class=\\"empl-indent\\">Основными принцами в своей работе считаю честность, мобильность, ответственность. Главная задача для меня — помочь клиенту решить все вопросы быстро и качественно, стараясь удовлетворить все его требования.</p>\\n\\n<p class=\\"empl-indent\\">Для этого я регулярно пополняю багаж своих знаний в сфере недвижимости. На данный момент я прослушала многочисленное количество семинаров, приняла участие в различных выставках, а также во множестве тренингов, как профессиональных, так и обучающих правильному подходу к клиенту.</p>\\n\\n<p class=\\"empl-indent\\">Я люблю свою работу и всегда с удовольствием помогаю клиентам!</p>\\n"},{"MIGX_id":"4","name":"Ярослав","image":"files/images/empl/employer-3-2.jpg","exp":"Ярослав - опыт работы агентом-риэлтором 2 года","desc":"<p>&nbsp;</p>\\n\\n<p>&nbsp;Основные принципы в работе – честность, порядочность, понимание, умение вникать в поставленную задачу (проблему) и находить оптимальные пути её решения, коммуникабельность, доброжелательное отношение.</p>\\n\\n<p>Помогу сдать ваше жилье по максимально-правильной цене, звоните в любое время&nbsp;&nbsp;&nbsp;&nbsp; 290-98-80</p>\\n"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
...
<head>
    ...
    <title>Сотрудники - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="about-us/employees.html" method="post">
...
<nav class="navigation" role="navigation">
    <div class="row">
        ...
        <div class="main-content row clearfix" role="main-content">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==8` 
                &tvPrefix=``]]
        ...
        <div class="hdb-link"><a href="want-to-stay/hot-deals.html">Все</a></div>
            ...
            <div class="mc-content-box employees-page">
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>Сотрудники - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
