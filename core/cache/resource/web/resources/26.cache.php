<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1408516308,
    'editedby' => 1,
    'editedon' => 1409013671,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1408516260,
    'publishedby' => 1,
...
<head>
    ...
    <title>Подать заявку - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="want-to-pass/apply.html" method="post">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==26` 
                &tvPrefix=``]]
        ...
        <div class="hdb-link"><a href="want-to-stay/hot-deals.html">Все</a></div>
            ...
            <div class="mc-content-box apply-page">
...
<form class="apply-form" action="want-to-pass/apply.html" method="post">
    <input id="af-blank" type="hidden" name="blank" value="[[!+fi.blank]]">
    
    <div class="af-title-big">Заявка</div>
    <div class="af-title-small">&nbsp;</div>
    
    <div class="af-form-group">
        <div class="af-label"><label for="af-text">Текст <em>*</em></label></div>
        <div class="af-input"><textarea name="text" id="af-text" class="af-inp af-textarea" placeholder="Опишите ваше предложение...">[[!fi.text]]</textarea></div>
        [[!fi.error.text:!empty=`<div class="af-error">[[!fi.error.text]]</div>`]]
    </div>
    <div class="af-form-group">
        <div class="af-label"><label for="af-name">Ваше имя</label></div>
        <div class="af-input"><input type="text" name="name" id="af-name" class="af-inp" value="[[!fi.name]]"></div>
        [[!fi.error.name:!empty=`<div class="af-error">[[!fi.error.name]]</div>`]]
    </div>
    <div class="af-form-group">
        <div class="af-label"><label for="af-phone">Телефон <em>*</em></label></div>
        <div class="af-input"><input type="text" name="phone" id="af-phone" class="af-inp" value="[[!fi.phone]]"></div>
        [[!fi.error.phone:!empty=`<div class="af-error">[[!fi.error.phone]]</div>`]]
    </div>
    <div class="af-form-group">
        <div class="af-label"><label for="af-email">E-mail <em>*</em></label></div>
        <div class="af-input"><input type="text" name="email" id="af-email" class="af-inp" value="[[!fi.email]]"></div>
        [[!fi.error.email:!empty=`<div class="af-error">[[!fi.error.email]]</div>`]]
    </div>
    <div class="af-form-group af-submit">
        <input type="submit" name="sub" class="af-sub" value="Отправить">
    </div>
</form>
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>Подать заявку - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
