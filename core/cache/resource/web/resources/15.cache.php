<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Комнаты с подселением',
    'longtitle' => 'Комнаты с подселением',
    'description' => '',
    'alias' => 'rooms-with-shares',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1408426967,
    'editedby' => 1,
    'editedon' => 1408930805,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1408426920,
    'publishedby' => 1,
    'menutitle' => 'Комнаты с подселением',
    'donthit' => 0,
    'privateweb' => 0,
    'privatemgr' => 0,
    'content_dispo' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'database-objects/rooms-with-shares.html',
    'uri_override' => 0,
...
<head>
    ...
    <title>Комнаты с подселением - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="database-objects/rooms-with-shares.html" method="post">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==15` 
                &tvPrefix=``]]
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>Комнаты с подселением - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
