<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Наши услуги для хозяев',
    'longtitle' => 'Услуги хозяевам',
    'description' => '',
    'alias' => 'services-for-the-hosts',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>Проводим бесплатные консультации. Ответим на все вопросы, связанные с арендой  недвижимости. </p>

<p>Можете связаться по телефону с консультантами «21 Века» и получить более подробную информацию о самом агентстве, больше узнать о нашей истории.</p>

<p class="fs-18"><b>Основной принцип нашей работы — максимально выгодное представление интересов клиентов. Для этого мы проводим следующие мероприятия:</b></p>

<ul>
	<li><strong>Бесплатный выезд специалиста на объект.</strong></li>
	<li><strong>Фотосъемка вашего объекта.</strong></li>
	<li><strong>Разработка и проведение эффективной рекламной кампании по сдаче вашего объекта.</strong></li>
	<li><strong>Эффективная схема взаимодействия с агентствами недвижимости, — о вашем объекте узнают все профессионалы города.</strong></li>
	<li><strong>Презентация вашего объекта на всех информационно-рекламных площадках города.</strong></li>
	<li><strong>Возможен весь комплекс услуг по доверенности.</strong></li>
	<li><strong>Сдача по максимальной рыночной цене в короткие сроки.</strong></li>
</ul>

<p>Услуги нашего агентства максимально удобны для собственников недвижимости. Подписав договор, клиент вступает в режим комфортного и безопасного процесса сдачи своего объекта.</p>
',
    'richtext' => 1,
    'template' => 8,
    'menuindex' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1408515461,
    'editedby' => 1,
    'editedon' => 1409016292,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1408515420,
    'publishedby' => 1,
    'menutitle' => 'Наши услуги для хозяев',
    'donthit' => 0,
    'privateweb' => 0,
    'privatemgr' => 0,
    'content_dispo' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'want-to-pass/services-for-the-hosts.html',
    'uri_override' => 0,
...
<head>
    ...
    <title>Наши услуги для хозяев - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="want-to-pass/services-for-the-hosts.html" method="post">
...
<nav class="navigation" role="navigation">
    <div class="row">
        ...
        <div class="main-content text-page row clearfix" role="main-content">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==24` 
                &tvPrefix=``]]
        ...
        <div class="hdb-link"><a href="want-to-stay/hot-deals.html">Все</a></div>
            ...
            <div class="mc-content-box text-page">
                <div class="text-contaner">
                    <h1>Услуги хозяевам</h1>
                
                    <p>Проводим бесплатные консультации. Ответим на все вопросы, связанные с арендой  недвижимости. </p>
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>Наши услуги для хозяев - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
