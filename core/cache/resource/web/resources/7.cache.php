<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h1>Об агентстве «21 ВЕК»</h1>

<p>Открытие Агентства недвижимости «21 ВЕК» состоялось 8 октября 2013 г. Несмотря на небольшой срок работы, мы добились больших результатов.<br />
В компании работают настоящие профессионалы, которые используют абсолютно новый подход к работе.</p>

<p>Мы работаем для Вас! Оказываем качественные и доступные услуги, ориентируясь на потребности клиентов. Мы стремимся сотрудничать с вами неоднократно и  хотим, чтобы после нашей работы, остались только хорошие впечатления. </p>

<p>Наша команда профессионалов имеет большой опыт работы в данной сфере, мы постоянно развиваемся и совершенствуемся для вас.  Работа с вами основывается на доверии и взаимопонимании. Обратитесь к нам и  мы не подведём!</p>

<p class="fs-16" style="text-align: center;"><strong>Мы делаем всё, чтобы вы были довольны агентством недвижимости «21 ВЕК» !</strong></p>
',
    'richtext' => 1,
    'template' => 7,
    'menuindex' => 1,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1408426297,
    'editedby' => 1,
    'editedon' => 1409012569,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1408426260,
    'publishedby' => 1,
    'menutitle' => 'История',
    'donthit' => 0,
    'privateweb' => 0,
...
<head>
    ...
    <title>История - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="about-us/history.html" method="post">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==7` 
                &tvPrefix=``]]
        ...
        <div class="hdb-link"><a href="want-to-stay/hot-deals.html">Все</a></div>
            ...
            <div class="mc-content-box history-page">
                <div class="hp-contaner">
                    <h1>Об агентстве «21 ВЕК»</h1>
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>История - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
