<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Горячие предложения',
    'longtitle' => 'Горячие предложения',
    'description' => '',
    'alias' => 'hot-deals',
    'link_attributes' => '',
    'published' => 1,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1408421345,
    'editedby' => 1,
    'editedon' => 1409017353,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1408421340,
    'publishedby' => 1,
    'menutitle' => 'Горячие предложения',
    'donthit' => 0,
    'privateweb' => 0,
    'privatemgr' => 0,
    'content_dispo' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'want-to-stay/hot-deals.html',
    'uri_override' => 0,
...
<head>
    ...
    <title>Горячие предложения - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="want-to-stay/hot-deals.html" method="post">
...
<nav class="navigation" role="navigation">
    <div class="row">
        ...
        <div class="main-content employees-page row clearfix" role="main-content">
            <div class="mc-content-box hot-deals-page">
                ...
                <div class="obj-page-box">
                    ...
                    [[!pdoResources? 
                        ...
                        &limit=`all` 
                        &parents=`27` 
                        &resources=`[[!#GET.obj:!empty=`-[[!#GET.obj]]`]]`
                        &processTVs=`1` 
                        &sortby=`publishedon` 
                        &tpl=`tpl.Obj` 
                        &tvFilters=`tv.Obj.Hot==1` 
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>Горячие предложения - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
