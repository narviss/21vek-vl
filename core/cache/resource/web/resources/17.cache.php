<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Квартиры посуточно',
    'longtitle' => 'Квартиры посуточно',
    'description' => '',
    'alias' => 'apartments-for-rent',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'database-objects/apartments-for-rent.html',
    'uri_override' => 0,
...
<head>
    ...
    <title>Квартиры посуточно - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="database-objects/apartments-for-rent.html" method="post">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==17` 
                &tvPrefix=``]]
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>Квартиры посуточно - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
