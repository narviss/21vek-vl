...
$_lang['setting_ckeditor.autocorrect_dash'] = 'Знак тире';
$_lang['setting_ckeditor.autocorrect_dash_desc'] = 'Символ, используемый в качестве замены дефиса между словами';
$_lang['setting_ckeditor.autocorrect_double_quotes'] = 'Знаки двойных кавычек';
...
$_lang['setting_ckeditor.autocorrect_single_quotes'] = 'Знаки одинарных кавычек';
