<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Документы для хозяев',
    'longtitle' => 'Документы для хозяев',
    'description' => '',
    'alias' => 'documents-for-the-hosts',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p><img alt="" src="assets/images/b-docs.png" style="width: 30px; height: 39px;" />&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<strong><a download="" href="files/docs/Agency_agreement_21century.docx">Агентский договор</a></strong></p>
',
    'richtext' => 1,
    'template' => 8,
    'menuindex' => 1,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1408515540,
    'editedby' => 1,
    'editedon' => 1409017211,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1408515540,
    'publishedby' => 1,
    'menutitle' => 'Документы для хозяев',
    'donthit' => 0,
    'privateweb' => 0,
    'privatemgr' => 0,
    'content_dispo' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'want-to-pass/documents-for-the-hosts.html',
    'uri_override' => 0,
...
<head>
    ...
    <title>Документы для хозяев - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="want-to-pass/documents-for-the-hosts.html" method="post">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==25` 
                &tvPrefix=``]]
        ...
        <div class="hdb-link"><a href="want-to-stay/hot-deals.html">Все</a></div>
            ...
            <div class="mc-content-box text-page">
                <div class="text-contaner">
                    <h1>Документы для хозяев</h1>
                
                    <p><img alt="" src="assets/images/b-docs.png" style="width: 30px; height: 39px;" />&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<strong><a download="" href="files/docs/Agency_agreement_21century.docx">Агентский договор</a></strong></p>
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>Документы для хозяев - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
