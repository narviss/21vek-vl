<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Документы для клиентов',
    'longtitle' => 'Документы для клиентов',
    'description' => '',
    'alias' => 'documents-for-clients',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p><img alt="" src="assets/images/b-docs.png" style="width: 30px; height: 39px;" />&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<strong><a download="" href="files/docs/Contract_of_employment_21century.docx">Договор найма</a></strong></p>
',
    'richtext' => 1,
    'template' => 8,
    'menuindex' => 1,
    ...
    'publishedby' => 1,
    'menutitle' => 'Документы для клиентов',
    'donthit' => 0,
    'privateweb' => 0,
    'privatemgr' => 0,
    'content_dispo' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'want-to-stay/documents-for-clients.html',
    'uri_override' => 0,
...
<head>
    ...
    <title>Документы для клиентов - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="want-to-stay/documents-for-clients.html" method="post">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==20` 
                &tvPrefix=``]]
        ...
        <div class="hdb-link"><a href="want-to-stay/hot-deals.html">Все</a></div>
            ...
            <div class="mc-content-box text-page">
                <div class="text-contaner">
                    <h1>Документы для клиентов</h1>
                
                    <p><img alt="" src="assets/images/b-docs.png" style="width: 30px; height: 39px;" />&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<strong><a download="" href="files/docs/Contract_of_employment_21century.docx">Договор найма</a></strong></p>
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>Документы для клиентов - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
