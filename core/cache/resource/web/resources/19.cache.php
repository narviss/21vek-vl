<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Наши услуги для клиентов',
    'longtitle' => 'Наши услуги для клиентов',
    'description' => '',
    'alias' => 'our-services-to-customers',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>Проводим бесплатные консультации. Ответим на все вопросы, связанные с арендой недвижимости. Можете связаться по телефону с консультантами 21 Века и получить более подробную информацию о самом агентстве, больше узнать о нашей истории.</p>

<p>Основной принцип нашей работы – максимально выгодное представление интересов клиентов. Квалифицированные специалисты агентства 21 Века быстро и качественно окажут следующие услуги:</p>

<p>&nbsp;- Аренда жилья на длительный срок и посуточно</p>

<p>&nbsp;- Проверка документов на аренду жилья</p>

<p>&nbsp;- Предоставление документов для командировочных лиц</p>

<p>&nbsp;- Быстрый поиск по общегородской базе квартир</p>

<p>&nbsp;- Организация просмотров объектов в любое удобное для вас время.</p>
',
    'richtext' => 1,
    'template' => 8,
    'menuindex' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1408515008,
    'editedby' => 1,
    'editedon' => 1409962244,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1408515000,
    'publishedby' => 1,
    'menutitle' => 'Наши услуги для клиентов',
    'donthit' => 0,
    'privateweb' => 0,
    'privatemgr' => 0,
    'content_dispo' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'want-to-stay/our-services-to-customers.html',
    'uri_override' => 0,
...
<head>
    ...
    <title>Наши услуги для клиентов - Агентство недвижимости «XXI Век» во Владивостоке</title>
...
<div id="modal-wind"[[!+mw.active:is=`1`:then=` class="active"`]]>
    <div class="mw-container clearfix">
        <div class="mw-windows">
            <form class="apply-form" action="want-to-stay/our-services-to-customers.html" method="post">
    ...
    <div class="mc-hot-deals">
        ...
        <div class="hdb-mini-container">
            [[!pdoResources? 
                ...
                &tvFilters=`tv.Obj.Hot==1,tv.Obj.Type==19` 
                &tvPrefix=``]]
        ...
        <div class="hdb-link"><a href="want-to-stay/hot-deals.html">Все</a></div>
            ...
            <div class="mc-content-box text-page">
                <div class="text-contaner">
                    <h1>Наши услуги для клиентов</h1>
                
                    <p>Проводим бесплатные консультации. Ответим на все вопросы, связанные с арендой недвижимости. Можете связаться по телефону с консультантами 21 Века и получить более подробную информацию о самом агентстве, больше узнать о нашей истории.</p>
...
<footer class="footer" role="footer">
  ...
  'elementCache' => 
  array (
    '[[$tmpl.Head.Other]]' => '    <title>Наши услуги для клиентов - Агентство недвижимости «XXI Век» во Владивостоке</title>
	<meta name="description" content="">
	<meta name="keywords" content="">
